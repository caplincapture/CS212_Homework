...
def is_letter(sq):
    #san: change is letter to handle upper and lower by always calling upper
...
def calculate_score(board, pos, direction, hand, word):
    ...
    for (n, L) in enumerate(word):
        ...
        # This handle blank tiles perfectly as they do not have points :-)
