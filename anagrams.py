...
def find_anagrams(letters, previous_word, shortest):
    # helper function, letters in the phrase with spaces replaced by nothing in original
    # previous word verifies that it's alphabetical
    # find words function, are they long enough
    # if there's no remainder add it
    results = set()
